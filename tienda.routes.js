...
router.post('/usuarios/crear', async (req, res) => {
    const usuario  = req.body
    const respuesta = await Usuario.nuevo(usuario)
    res.send(respuesta)
})
// Editar Usuari
router.put('/usuarios/editar', async (req, res) => {
    const usuario  = req.body
    const respuesta = await Usuario.actualizar(usuario)
    res.send(respuesta)
})

router.get('/usuarios', async (req, res) => {
    const usuario = await Usuario.todos()
    res.send(usuario)
})
...
// edit
router.put('/clientes/editar', async (req, res) => {
    const cliente  = req.body
